...
const HoverButton = React.memo(({ text, hoverKey, style }) => {
  ...
  const mouseIn = () => setHover(hoverKey);
  const mouseOut=()=> {
	setHover("");
  };

  return (
    <div id = "HoverButton.js" style={{display:"flex", justifyContent: "center", alignItems:"center", top: 0, left: 0, right: 0, bottom: 0, position:"absolute"}}>
