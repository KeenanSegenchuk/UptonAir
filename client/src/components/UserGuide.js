...
function UserGuide() {
	...
	<div id="UserGuide.js" style={{border:"2px solid white"}}>
	    ...
	    <img alt="" src="figs/UG_dashboard.png" width="50%" height="auto" style={{marginLeft:"25%", padding:"15px"}}/>
	    <p class="centered s12">		
	    ...
	    <img alt="" src="figs/UG_changesensor.png" width="50%" height="auto" style={{marginLeft:"25%", padding:"15px"}}/>
	    <p class="centered s12">		
	    ...
	    <img alt="" src="figs/UG_map.png" width="50%" height="auto" style={{marginLeft:"25%", padding:"15px"}}/>
	    <p class="centered s12">
	    ...
	    <img alt="" src="figs/UG_linegraph.png" width="50%" height="auto" style={{marginLeft:"25%", padding:"15px"}}/>
	    <p class="centered s12">
	    ...
	    <img alt="" src="figs/UG_channeldiff.png" width="50%" height="auto" style={{marginLeft:"25%", padding:"15px"}}/>
	    <p class="centered s12">
